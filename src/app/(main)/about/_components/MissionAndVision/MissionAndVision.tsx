...
const MissionAndVision = () => {
  return (
    <section className="mx-auto max-w-400 px-4 pb-12">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="group relative rounded-md border border-slate-100 bg-white p-6 text-center shadow-xs transition-all duration-300 hover:border-emerald-100 hover:shadow-sm">
          ...
          <h3 className="mb-2 text-lg font-semibold tracking-tight md:text-xl">Our Mission</h3>
        ...
        <div className="group relative rounded-md border border-slate-100 bg-white p-6 text-center shadow-xs transition-all duration-300 hover:border-emerald-100 hover:shadow-sm">
          ...
          <h3 className="mb-2 text-lg font-semibold tracking-tight md:text-xl">Our Vision</h3>
          <p className="text-text-secondary text-sm leading-relaxed">
