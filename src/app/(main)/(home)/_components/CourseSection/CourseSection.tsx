    ...
    <section className="bg-[#F9FAFB] py-20">
      <div className="mx-auto max-w-400 px-6">
        ...
        <div className="mb-14 flex flex-col justify-between md:flex-row md:items-end">
          ...
          <button className="cursor-pointer rounded-sm bg-[#34796F] px-6 py-3 font-medium text-white transition-all hover:bg-[#2a6159] active:scale-95 md:mt-0">
            View More
          </button>
        </div>
            ...
            <div key={course?.id} className="group cursor-pointer">
              ...
              <div className="relative mb-3 h-65 w-full overflow-hidden rounded-md transition-all duration-500 ease-in-out group-hover:shadow-sm group-hover:shadow-emerald-100">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-[#34796F]/10 opacity-0 backdrop-blur-[2px] transition-all duration-300 group-hover:opacity-100">
                  <div className="translate-y-4 transform rounded-full bg-[#34796F] p-4 text-white shadow-md transition-transform duration-300 group-hover:translate-y-0">
              ...
              <div className="flex items-center justify-between px-1">
                <h3 className="text-lg font-semibold text-[#0F172A] transition-colors duration-300 group-hover:text-[#34796F]">
                  {course?.title}
                </h3>
