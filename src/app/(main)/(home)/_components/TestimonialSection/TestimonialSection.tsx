        ...
        <div className="relative h-full w-full">
          <Marquee gradient={true} gradientColor="white" speed={45} pauseOnHover={true}>
            {testimonials.map((item) => (
              <div
                key={item?.id}
                className="group mx-4 w-100 cursor-pointer rounded-md border border-slate-100 bg-white p-6 text-left transition-all duration-300 hover:border-emerald-100 hover:shadow-sm"
              >
                {/* Quote Icon */}
