        ...
        <div className="max-w-3xl">
          ...
          <div className="mb-4 flex flex-wrap items-center gap-2 sm:mb-5">
            ...
            <span className="rounded-sm bg-white/10 px-3 py-1 text-xs font-semibold text-white backdrop-blur-sm">
              {course.category}
              {course.subCategory && (
                <span className="ml-1 opacity-70">&gt; {course.subCategory}</span>
              )}
            </span>
            <span className="rounded-sm bg-white/10 px-3 py-1 text-xs font-semibold text-white backdrop-blur-sm">
              {course.level}
          ...
          {/* Instructor */}
          <div className="flex w-full scrollbar-none items-center gap-3 overflow-x-auto rounded-md border border-white/10 bg-white/5 p-3 backdrop-blur-sm [-ms-overflow-style:none] sm:w-fit sm:min-w-105 sm:justify-between sm:gap-4 sm:p-4 [&::-webkit-scrollbar]:hidden">
            ...
            <div className="ml-auto flex shrink-0 items-center gap-4 border-l border-white/10 pl-4 sm:ml-auto sm:pl-5">
